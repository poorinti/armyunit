<x-app-layout>
    <x-slot name="header5">
        <h2 class="text-xl font-semibold leading-tight text-white">
           เพิ่มข้อมูล ผู้รับสิทธิ์ด้วย excel
        </h2>
    </x-slot>
            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class=" card">
                            <div class="card">
                                <div class="card-header">Import ผู้รับสิทธิ์ </div>
                                     <div class="card-body">
                                        <form action="{{ url('/pay/excel/import') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="flex-row-reverse d-flex justify-content-end ">
                                                ...
                                                <div class="my-3 form-group">
                                                    ...
                                                    <label for="excel_import">อัพโหลด excel </label>
                                         ...
                                         <br>
                                         <a href="/pay/all" class="bg-blue-700 btn"><i class="fa fa-arrow-left"></i> กลับ</a>
