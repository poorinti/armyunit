        ...
        ">
            @if (Route::has('login'))
                <div class="z-10 p-6 text-right sm:fixed sm:top-0 sm:right-0">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="font-semibold text-white hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>
            ...
            >
                ...
                <h1 class="text-white display-6 fw-bold">ระบบฐานข้อมูลหน่วยฝึกทหารใหม่ กองพลทหาราบที่ 6</h1>
